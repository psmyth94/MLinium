...
from mlinium.pipeline import pipeline
...
class Args:
    ...
    report_to: str = ""
    wandb_notes: str = ""
    wandb_project_name: str = "mlinium"
    debug: bool = False
    ...
    optuna_study_name: str = "mlinium_study"
    optuna_storage: Optional[str] = None
    training_iterations: int = 30
    eval_loss: Optional[str] = None
    study_name: str = "mlinium_study"
...
def main():
    ...
    if args.hyperparameter_tuning:
        if args.hyperparameter_strategy == "optuna":
            from mlinium.integrations.optuna import optuna_pipeline

            optuna_pipeline(args)
        else:
            from mlinium.integrations.ray import ray_tune_pipeline
